...
import com.leanderchristmann.flyleaf.adapters.VarCatAdapter;

public class VarCatItemTouchHelper extends ItemTouchHelper.Callback {

    private final VarCatItemTouchHelperAdapter varCatItemTouchHelperAdapter;

    public VarCatItemTouchHelper(VarCatItemTouchHelperAdapter varCatItemTouchHelperAdapter) {
        this.varCatItemTouchHelperAdapter = varCatItemTouchHelperAdapter;
    }
    ...
    public int getMovementFlags(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder viewHolder) {
        if (viewHolder instanceof VarCatAdapter.ViewHolderPlus) return 0;
    ...
    public boolean onMove(@NonNull RecyclerView recyclerView, @NonNull RecyclerView.ViewHolder source, @NonNull RecyclerView.ViewHolder target) {
        ...
        varCatItemTouchHelperAdapter.onItemMove(source.getAdapterPosition(), target.getAdapterPosition());
        return true;
    }

    @Override
    public void onSwiped(@NonNull RecyclerView.ViewHolder viewHolder, int direction) {
        varCatItemTouchHelperAdapter.onItemSwiped(viewHolder.getAdapterPosition());
    }
}
